...
fetch ('animal.json')
    ...
    .then (data =>{
        ...
        main.title30=data.title30;
        main.title31=data.title31;
        main.title32=data.title32;
        main.title33=data.title33;
        main.title34=data.title34;
        main.title35=data.title35;
        main.title36=data.title36;
        main.title37=data.title37;
        main.title38=data.title38;
        main.title39=data.title39;
